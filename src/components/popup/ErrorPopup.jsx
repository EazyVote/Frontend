...
import cancel from "../../assets/cancel.mp4";

const ErrorPopup = () => {
  const [errorPopup] = useGlobalState("errorPopup");

  const onClose = () => {
    setGlobalState("errorPopup", "scale-0");
  };
      ...
      <div className="bg-white shadow-xl shadow-black rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
        ...
        <div className="flex justify-center items-center mt-5">
          <div className="rounded-full overflow-hidden w-48 h-48">
            <video src={cancel} autoPlay loop muted></video>
          </div>
        </div>
