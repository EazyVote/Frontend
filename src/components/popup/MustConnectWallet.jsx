      ...
      <div className="bg-white shadow-xl shadow-black rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
        ...
        <div className="flex justify-center items-center mt-5">
          <div className="rounded-full overflow-hidden w-48 h-48">
            <video src={bitcoinLock} autoPlay loop muted></video>
          </div>
        </div>
        ...
        <div className="font-normal text-md text-center flex justify-center items-center">
          <h1>
            Please connect your wallet to experience the complete features of
            our platform.
          </h1>
        </div>
        <div className="mt-4 flex justify-center items-center">
          <button
            type="button"
            className="w-full font-bold shadow-sm rounded-full py-4 bg-primary text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline"
          >
            ...
            <span className="ml-4 text-white">Connect Wallet</span>
          </button>
        </div>
      </div>
    </div>
...
export default MustConnectWallet;
